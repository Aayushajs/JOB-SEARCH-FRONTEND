...
const AdminDashboard = () => {
  ...
  return (
    ...
    <div className="p-10 bg-gray-50 min-h-screen py-20">
      <Navbar/>
      <h2 className="text-4xl font-bold mb-8 text-center text-gray-800">Admin Dashboard: Upload Banner</h2>
      ...
      <div className="flex flex-col md:flex-row max-w-6xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
        ...
        >
          ...
          <div className="mb-6">
            <label className="block text-gray-700 mb-2 font-medium">Link</label>
            <input
              type="text"
              className="w-full p-3 border border-gray-300 rounded focus:ring focus:ring-blue-300"
              value={link}
      ...
      <h3 className="text-3xl font-bold mt-12 mb-6 text-center text-gray-800">Uploaded Banners</h3>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {banners.map((banner) => (
          <div key={banner._id} className="bg-white p-6 shadow-lg rounded-lg hover:shadow-2xl transition-shadow duration-300">
            ...
            />
            <h4 className="text-xl font-bold mt-4 text-gray-800">{banner.title}</h4>
